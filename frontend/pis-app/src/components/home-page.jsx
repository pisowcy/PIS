    ...
    // <div>
      <section className="px-6 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <Movie title="Avengers" description="This is Avengers movie" />
          <Movie title="AAAAA" description="BBBB" />
          <Movie title="BBBBBBB" description="BBBBB"/>
          <Movie title="CCCCCCCC" description="CCCCCCC" />
        </div>
      </section>
    // </div>
  )
